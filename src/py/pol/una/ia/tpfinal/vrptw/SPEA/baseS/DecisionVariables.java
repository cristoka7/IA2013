...
import py.pol.una.ia.tpfinal.vrptw.SPEA.base.variable.BinaryReal;
import py.pol.una.ia.tpfinal.vrptw.SPEA.base.variable.Int;
import py.pol.una.ia.tpfinal.vrptw.SPEA.base.variable.Permutation;
import py.pol.una.ia.tpfinal.vrptw.SPEA.base.variable.Real;
      ...
      for (int var = 0; var < problem_.getNumberOfVariables(); var++) {
        if (problem.getPrecision() == null) {
          ...
          for (int i = 0; i < problem.getNumberOfVariables(); i++)
            precision[i] = py.pol.una.ia.tpfinal.vrptw.SPEA.baseS.Configuration.DEFAULT_PRECISION ;
