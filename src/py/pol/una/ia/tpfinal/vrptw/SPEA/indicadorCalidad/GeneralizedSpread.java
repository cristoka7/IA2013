...
package py.pol.una.ia.tpfinal.vrptw.SPEA.indicadorCalidad;
...
public class GeneralizedSpread {
  ...
  static py.pol.una.ia.tpfinal.vrptw.SPEA.metricas.MetricsUtil utils_;  // MetricsUtil provides some 
  ...
  public GeneralizedSpread() {
    utils_ = new py.pol.una.ia.tpfinal.vrptw.SPEA.metricas.MetricsUtil();
  } // GeneralizedSpread
  ...
  public double generalizedSpread(double [][] paretoFront,
    ...
    for (int i = 0; i < numberOfObjectives; i++) {
      Arrays.sort(normalizedParetoFront,new py.pol.una.ia.tpfinal.vrptw.SPEA.metricas.ValueComparator(i));
    ...
    Arrays.sort(normalizedFront,new py.pol.una.ia.tpfinal.vrptw.SPEA.metricas.LexicoGraphicalComparator());
