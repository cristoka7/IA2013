...
public class Spread {
  ...
  static py.pol.una.ia.tpfinal.vrptw.SPEA.metricas.MetricsUtil utils_;//utils_ is used to access to 
  ...
  public double spread(double [][] front, 
    ...
    Arrays.sort(normalizedFront,
    		    new py.pol.una.ia.tpfinal.vrptw.SPEA.metricas.LexicoGraphicalComparator());
